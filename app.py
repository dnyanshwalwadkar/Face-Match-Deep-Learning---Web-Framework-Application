...
feature_list = pickle.load(open('E:/AI-Projects-UDEMY/Which-Bollywood-Celebrity-You-look-like-main/artifacts/extracted_features/embedding.pkl','rb'))
filenames = pickle.load(open('E:/AI-Projects-UDEMY/Which-Bollywood-Celebrity-You-look-like-main/artifacts/pickle_format_data/img_PICKLE_file.pkl','rb'))
...
# recommend image
def recommend(feature_list,result):
    similarity = []
...
if uploaded_image is not None:
    ...
    if save_uploaded_image(uploaded_image):
        ...
        result = extract_features(os.path.join("E:/AI-Projects-UDEMY/Which-Bollywood-Celebrity-You-look-like-main/artifacts/uploads",uploaded_image.name),model,detector)
        ...
        index_pos = sorted(list(enumerate(similarity)), reverse=True, key=lambda x: x[1])[0][0]
        #index_pos = recommend(feature_list,result)
        predicted_actor = " ".join(filenames[index_pos].split('\\')[4].split('_'))
        # display
        col1,col2 = st.columns(2)
        re = Image.open(filenames[index_pos])
