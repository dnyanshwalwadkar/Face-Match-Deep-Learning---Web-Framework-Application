...
def generate_data_pickle_file(config_path,params_path):
    ...
    data_path ="E:\AI-Projects-UDEMY\Which-Bollywood-Celebrity-You-look-like-main\data"
...
if __name__ == '__main__':
    ...
    args.add_argument("--config", "-c", default="E:/AI-Projects-UDEMY/Which-Bollywood-Celebrity-You-look-like-main/config/config.yaml")
    args.add_argument("--params", "-p", default="E:\AI-Projects-UDEMY\Which-Bollywood-Celebrity-You-look-like-main\params.yaml")
